...
<head>
    ...
    <link href="{{ asset('admin_asset/https://fonts.googleapis.com/css2?family=Inter:wght@300;400;600&display=swap') }}"
        rel="stylesheet">
</head>
        ...
        <div class="main">
                    ...
                    <ul class="navbar-nav navbar-align">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-end">
                                ...
                                <!-- Logout Form -->
                                <div class="px-3 py-2">
                                    <button class="btn btn-warning w-100" onclick="confirmLogout()">
            ...
            <main class="content">
                <div class="container-fluid p-0">
                    ...
                    <h1 class="h3 mb-3"> @yield('admin_layout')</h1>
    ...
    function confirmLogout() {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                form.method = 'POST';
                form.action = '{{ route('logout') }}'; // Adjust this route accordingly  
                const csrfInput = document.createElement('input');
                csrfInput.type = 'hidden';
                csrfInput.name = '_token';
                csrfInput.value = '{{ csrf_token() }}'; // Ensure this CSRF token matches your setup  
